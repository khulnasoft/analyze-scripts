...
from khulnasoft_analyze_sdk.analysis import FileAnalysis, SubAnalysis
...
def generate_reports(khulnasoft_apikey, files_sha256):
    api.set_global_api(khulnasoft_apikey)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Generate a PDF and HTML reports for a given Khulnasoft file scan")
