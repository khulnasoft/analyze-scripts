...
def date_conversion(khulnasoft_api_key, start_date_str: str, end_date_str: str = None):
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Extracting IOCs of all Khulnasoft analysis from a given '
